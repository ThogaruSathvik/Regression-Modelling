...
```{r}
n_149_with_Duans <- read_excel("n=149 with Duans.xlsx")
X091522_LABWORKS_DOWNLOAD <- read_excel("091522 LABWORKS DOWNLOAD.xlsx")
```
...
```{r}
pearson_data <- read_excel("1 of 3 - USGS gage data downloaded 092022.xlsx", 
